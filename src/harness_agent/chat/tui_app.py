...
class TuiApp:
    ...
    def __init__(
        ...
        # ── 滚动控制器 ──
        # vertical_scroll 由 ScrollController 直接控制（_ScrollableWindow 重写 _scroll），
        # 绕过 prompt_toolkit 的 cursor-driven clamp（会让只读内容区无法上滚）。
        # 详见 scroll_controller.py。
